      ...
      {items.map((item, index) => (
        <div key={index} style={{
          ...
          <div style={{ width: '40%', flexShrink: 0, paddingRight: '40px' }}>
            <div className="content-body-text" style={{ fontSize: '26px', lineHeight: '42px', color: '#542410' }}>
              {item.text}
            </div>
          </div>
          {/* Chart Section */}
     ...
     <div className="page-two-content" style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto', width: '85%' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <p style={{ marginBottom: '20px', fontSize: '26px', letterSpacing: '2px', lineHeight: '42px' }}>
            面对日益拥挤的咖啡赛道，低价成为品牌打开更广阔的消费市场的破局之刃。近年来，各大咖啡品牌的价格战已逐渐成为常态化竞争，其激烈与持久度远超外界想象。
          </p>
          <p style={{ fontSize: '26px', letterSpacing: '2px', lineHeight: '42px' }}>
      ...
      <FullWidthText>
        <p style={{ fontWeight: 'bold', fontSize: '26px', marginBottom: '1em', textAlign: 'center' }}>
          企业敢于打持久价格战的底气，并非单纯依赖补贴或短期让利，<br />而是建立在对成本结构和运营效率的系统性重塑之上。
        </p>
      </FullWidthText>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'stretch', height: '400px', marginBottom: '60px', width: '100%' }}>
        <div style={{ width: '36%', flexShrink: 0, display: 'flex', alignItems: 'center', overflow: 'visible', justifyContent: 'flex-start', position: 'relative', marginTop: '-130px' }}>
          ...
          <div style={{
            ...
            fontWeight: 'normal',
            textAlign: 'justify',
            fontFamily: '"Noto Serif SC", "Source Han Serif SC", "Noto Serif SC", "Source Han Serif SC", "SimSun", "Songti SC", serif', // Added Songti font
            textIndent: '2em'
          }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'stretch', height: '450px', marginBottom: '60px', width: '100%', marginTop: '110px' }}>
        <div style={{ width: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', overflow: 'visible', justifyContent: 'flex-start', position: 'relative', marginTop: '-130px' }}>
          ...
          <div style={{
            ...
            fontWeight: 'normal',
            textAlign: 'justify',
            fontFamily: '"Noto Serif SC", "Source Han Serif SC", "Noto Serif SC", "Source Han Serif SC", "SimSun", "Songti SC", serif',
            textIndent: '2em'
          }}>
      ...
      {/* Block: Starbucks Intro with Image 6 Background */}
       <div style={{ 
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: '26px', lineHeight: '42px', textAlign: 'justify', textIndent: '2em', color: '#542410' }}>
           ...
           minHeight: '400px'
            ...
            <div style={{ flex: 1, paddingRight: '40px' }}>
              <div className="content-body-text" style={{ color: '#542410', textAlign: 'justify' }}>
                <p style={{ fontSize: '26px', lineHeight: '42px' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ flex: 1, paddingLeft: '40px' }}>
            <div className="content-body-text" style={{ color: '#542410', textAlign: 'justify', fontFamily: '"Noto Serif SC", "Source Han Serif SC", "SimSun", "Songti SC", serif' }}>
              <p style={{ fontSize: '26px', lineHeight: '42px' }}>
      ...
      <FullWidthText>
        <p style={{ fontWeight: 'bold', marginBottom: '1em', fontSize: '26px', textAlign: 'center', marginTop: '175px' }}>
      ...
      <FullWidthText>
        <p style={{ fontWeight: 'bold', marginBottom: '1em', fontSize: '26px', textAlign: 'center', marginTop: '0px' }}>
          两个品牌在城市层级上的布局差异，直接对应了各自对价格竞争和成本控制的承受能力。
        </p>
      </FullWidthText>
      ...
      <div style={{
        ...
        <div style={{ width: '50%', paddingLeft: '20px', paddingRight: '100px', boxSizing: 'border-box', position: 'relative' }}>
          ...
          <p style={{ fontSize: '26px', lineHeight: '42px', textAlign: 'justify', margin: 0, position: 'relative', zIndex: 1 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ marginBottom: '40px', fontSize: '30px', lineHeight: '48px', letterSpacing: '2px' }}>
            如果说价格战首先是企业对消费环境变化的回应，那么它真正能否成立，还取决于消费者如何看待和使用这些更低价的咖啡。
          </p>
          <p style={{ fontSize: '30px', lineHeight: '48px', letterSpacing: '2px' }}>
      ...
      <div style={{
        ...
        <div style={{ width: '85%', maxWidth: '1200px' }}>
          ...
          <FullWidthText>
            <p style={{ fontWeight: 'bold', marginBottom: '1em', fontSize: '26px', lineHeight: '42px' }}>
          ...
          <FullWidthText style={{ marginTop: '-25px' }}>
            <p style={{ fontSize: '26px', lineHeight: '42px' }}>
